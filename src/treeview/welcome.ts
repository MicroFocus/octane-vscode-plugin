    ...
    async getHtmlForWebview(webview: vscode.Webview): Promise<string> {
        ...
        return `<!DOCTYPE html>
			...
			<head>
				...
				<title>Welcome to Core Software Delivery Platform</title>
			</head>
			<body>
                ...
                <div class="main-container" style="flex-direction: row; align-items: center;">
                    ...
                    <span 
                        title="Log into Core Software Delivery Platform directly with your username and password, in non-SSO environments. This method saves your login credentials between sessions, so you do not have to re-enter them." 
                ...
                <div class="main-container" style="flex-direction: row; align-items: center;">
                    ...
                    <span 
                        title="Log into Core Software Delivery Platform using a browser. You can use this method for non-SSO, SSO, and federated environments. Your login credentials are not saved between sessions, so you will have to re-enter them each time." 
                        style="margin: 0rem 0rem 0rem 0.5rem; cursor: pointer; display: flex;">
                        <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="16px" height="16px" viewBox="0 0 16 16" enable-background="new 0 0 16 16" xml:space="preserve">  <image id="image0" width="16" height="16" x="0" y="0"
                            href="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQCAMAAAAoLQ9TAAAABGdBTUEAALGPC/xhBQAAACBjSFJN
                        AAB6JgAAgIQAAPoAAACA6AAAdTAAAOpgAAA6mAAAF3CculE8AAAAkFBMVEX///9IjrdKkblMk7pM
