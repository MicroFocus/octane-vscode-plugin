        ...
        var filter = $('#filter_multiselect').multiselect({
            ...
            templates: {
                ...
                button: '<button  title="Select fields for this entity type" style="padding: unset; margin: 1rem 0rem 0rem 0rem;" id="filterBUttonId" data-toggle="dropdown" class="dropleft">' +
                    ...
                    + '</button>',
                buttonGroup: `<div class="multiselect-buttons btn-group" style="display:flex;">
                                <button id="allButton" class="multiselect-all">All</button>
                                <input id="allInput" style="display: none;" class="form-check-input" type="checkbox" value="multiselect-all">
                                <script>
                                    document.getElementById('allButton').addEventListener("click", function() {
                                        document.getElementById('allInput').click();
                                    });
                                </script>
                                <button class="multiselect-reset" id="noneButton">None</button>
                                <button id="noneButtonOriginal" style="display: none" type="button" class="btn btn-sm btn-block btn-outline-secondary">None</button>
                                <script>
                                    document.getElementById('noneButton').addEventListener("click", function() {
                                        document.getElementById('multiselect-reset').click();
                                    });
                                </script>
                                <button>Reset</button>
                              </div>`,
                buttonGroupReset: '<button type="button" class="multiselect-reset btn btn-secondary btn-block">vvvv</button>',
